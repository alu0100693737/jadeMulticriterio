...
public class agenteTipoPromethee extends Agent {
	...
	private ArrayList<ArrayList<Float>> indicesPreferencia;
	...
	class comportamientoPrometheo extends OneShotBehaviour {
		...
		public int funcionTipoI() {
			
		}

		public int funcionTipoII() {
			
		}
		
		public int funcionTipoIII() {
			
		}
		
		public int funcionTipoIV() {
			
		}
		
		public int funcionTipoV() {
			
		}
		
		public int funcionTipoVI() {
			
		}
		
		public void flujoPositivo() {
